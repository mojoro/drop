...
const GEORGE_VOICE  = 'JBFqnCBsd6RMkjVDRZzb' // George  — warm British male
const JESSICA_VOICE = 'cgSgspJ2msm6clMCkdW9' // Jessica — bright, warm American
...
async function main() {
  ...
  for (const line of SCRIPT) {
    const voiceId = line.speaker === 'ALEX' ? GEORGE_VOICE : JESSICA_VOICE
    const label = line.speaker === 'ALEX' ? 'George (Alex)' : 'Jessica (Sam)'
